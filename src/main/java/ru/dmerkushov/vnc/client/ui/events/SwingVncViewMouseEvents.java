 ...
 * @author dmerkushov
 */
public class SwingVncViewMouseEvents implements MouseListener, MouseMotionListener, MouseWheelListener {

	private final RfbClientSession session;

	public SwingVncViewMouseEvents (RfbClientSession session) {
